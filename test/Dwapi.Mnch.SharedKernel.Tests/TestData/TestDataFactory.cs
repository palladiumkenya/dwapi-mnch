...
namespace Dwapi.Mnch.SharedKernel.Tests.TestData.TestData
{
    public class TestDataFactory
    {
        ...
        public static List<PatientMnch> TestClients(int siteCode, Guid facilityId, int count = 5)
        {
            var patientIndices = Builder<PatientMnch>.CreateListOfSize(count)
